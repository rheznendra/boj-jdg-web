                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-7 col-md-7 col-12">
                                <div class="custom-file">
                                    {!! Form::file('file', ['class' => 'custom-file-input' . ($errors->has('file') ? ' is-invalid' : null), 'required', 'accept' => 'application/pdf,application/zip,application/x-rar,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/msword']) !!}
